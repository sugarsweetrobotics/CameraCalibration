  ...
  : public RTC::DataFlowComponentBase
{
	 public:
	   ...
	   */
	  CameraCalibration(RTC::Manager* manager);
	 ...
	 protected:
	   ...
	   * - DefaultValue: 10
	   */
	  short int m_image_num;
	  /*!
	   * 
	   * - Name:  chess_pattern_row
	   * - DefaultValue: 7
	   */
	  short int m_chess_pattern_row;
	  /*!
	   * 
	   * - Name:  chess_pattern_column
	   * - DefaultValue: 10
	   */
	  short int m_chess_pattern_column;
	  /*!
	   * 
	   * - Name:  chess_pattern_size
	   * - DefaultValue: 24.0
	   */
	  double m_chess_pattern_size;
	  /*!
	   * 
	   * - Name:  output_file_name
	   * - DefaultValue: calib.yml
	   */
...
extern "C"
{
  DLL_EXPORT void CameraCalibrationInit(RTC::Manager* manager);
};
